    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-base-950 border border-base-800 rounded-2xl shadow-2xl p-8 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            disabled={loading} 
            className="w-full flex items-center justify-center gap-2 bg-accent-600 hover:bg-accent-500 text-white rounded-xl py-2.5 font-medium transition-all active:scale-[0.98] disabled:opacity-70 disabled:pointer-events-none mt-2 shadow-lg shadow-accent-500/20"
          >
        ...
        <p className="text-sm text-center text-base-400 mt-8">
          ...
          <Link to="/signup" className="text-accent-400 font-medium hover:text-accent-300 transition-colors">
            Sign up for free
          </Link>
        </p>
